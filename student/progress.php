...
$pageTitle = "Progress - " . $subject['name'];
        ...
        <div class="col-md-8">
            <div class="text-center py-5">
                ...
                <p class="lead text-muted mb-4">
                    This feature is currently under development. Detailed progress analytics and performance tracking will be available here soon.
                </p>
