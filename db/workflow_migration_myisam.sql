-- =====================================================
-- WORKFLOW SYSTEM MIGRATION - MyISAM Compatible
-- =====================================================
-- This version works with MyISAM (no foreign key constraints)
-- Creates tables without FK constraints for compatibility
...
-- Step 6: Create workflow_logs table (NO FOREIGN KEYS for MyISAM compatibility)
...
-- Step 7: Create workflow_notifications table (NO FOREIGN KEYS)
CREATE TABLE IF NOT EXISTS workflow_notifications (
    ...
    INDEX idx_notifications_submission (submission_id)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4;

-- Step 8: Create workflow_settings table (NO FOREIGN KEYS)
...
-- Step 10: Create moderation_history table (NO FOREIGN KEYS)
...
-- Step 11: Create evaluation_locks table (NO FOREIGN KEYS)
