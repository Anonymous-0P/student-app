...
CREATE TABLE IF NOT EXISTS question_papers (
    ...
    grade_level ENUM('10th', '12th') NOT NULL,
...
-- Sample subjects with pricing (in Indian Rupees)
INSERT INTO subjects (code, name, description, department, year, semester, price, duration_days, is_active) VALUES
('CS101', 'Introduction to Programming', 'Learn the fundamentals of programming using C++ and Python. Perfect for beginners with hands-on projects and assignments.', 'Computer Science', 1, 1, 4999.00, 365, 1),
('CS201', 'Data Structures', 'Comprehensive course covering fundamental data structures including arrays, linked lists, stacks, queues, trees, and graphs with practical implementations.', 'Computer Science', 2, 3, 5999.00, 365, 1),
('CS202', 'Database Systems', 'Complete database systems course covering SQL, database design, normalization, and database management concepts with real-world projects.', 'Computer Science', 2, 3, 5499.00, 365, 1),
('CS301', 'Operating Systems', 'Understand the core concepts of operating systems including process management, memory management, file systems, and system security.', 'Computer Science', 3, 5, 6999.00, 365, 1),
('CS302', 'Computer Networks', 'Comprehensive networking course covering protocols, network architecture, security, and network programming with lab exercises.', 'Computer Science', 3, 5, 6499.00, 365, 1),
('MATH101', 'Calculus I', 'Introduction to differential and integral calculus with applications in engineering and computer science.', 'Mathematics', 1, 1, 3999.00, 365, 1),
('MATH201', 'Linear Algebra', 'Vector spaces, matrices, eigenvalues, and linear transformations with applications in data science and machine learning.', 'Mathematics', 2, 3, 4999.00, 365, 1),
('PHY101', 'Physics I', 'Fundamental physics concepts including mechanics, waves, thermodynamics, and their applications in technology.', 'Physics', 1, 1, 4499.00, 365, 1),
('ENG101', 'Technical Writing', 'Essential technical writing skills for engineers and computer scientists including documentation and communication.', 'English', 1, 1, 2999.00, 365, 1),
('CHEM101', 'General Chemistry', 'Basic chemistry principles including atomic structure, chemical bonding, and reactions with laboratory work.', 'Chemistry', 1, 1, 4299.00, 365, 1)
