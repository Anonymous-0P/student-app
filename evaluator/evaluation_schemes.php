...
// Get evaluator's assigned subjects
...
");
$assigned_subjects_query->bind_param("i", $evaluator_id);
        ...
        <?php else: ?>
            <div class="col-12">
                <div class="alert alert-info">
                    ...
                    <?= empty($subject_ids) ? 'No assignments found. Please contact admin.' : 'No evaluation schemes available for your assigned subjects.' ?>
                </div>
            </div>
        <?php endif; ?>
    </div>
